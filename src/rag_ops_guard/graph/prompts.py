...
QUERY_ANALYSIS_PROMPT = (
    ...
    "Questions ABOUT policies, runbooks, retries, old versus current guidance, destructive operations, "
    "or which policy applies are legitimate operational questions and MUST use safety_category=normal.\n"
    "Do not infer malicious intent merely because the request contains words such as policy, runbook, "
    "retry, old, current, unsafe, replay, or production.\n\n"
